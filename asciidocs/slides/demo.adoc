...
* :sun: Über **190 PV-Module** auf dem Schuldach
* :zap: Erzeugen **grünen Strom** für die Schule
* :bar_chart: Bisher: Daten nur in Rohform verfügbar
* :dart: **Ziel**: Echtzeit-Dashboard mit Ertrag, Einspeisung, CO₂-Einsparung
